//
// Created by issei on 2020/11/30.
//
...
std::vector<std::vector<double> > Mnist::readTrainingFile(std::string filename){
...
std::vector<double> Mnist::readLabelFile(std::string filename){
    std::ifstream ifs(filename.c_str(),std::ios::in | std::ios::binary);
    int magic_number = 0;
    int number_of_images = 0;
    ...
    std::vector<double> label(number_of_images);
